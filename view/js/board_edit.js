...
function func_board_preview() {
    document
        .getElementById("board_add_preview")
...
function board_edit_editor(title = "", conent = "") {
    document.getElementById("main_data").innerHTML =
        `
        <section id="board">
            <div class="container p-5 board-content">
                <div class="row gap-5">
                    <div class="col shadow rounded-5">
                        <div class="container px-3">
                            <br>    
                            <div class="input-group mb-3">
                                <input id="board_add_title" type="text" value="` +
        xss_filter(title) +
        `" class="form-control" placeholder="제목" aria-label="제목" aria-describedby="basic-addon2">
                            </div>
                            <textarea id="board_add_content" class="form-control" rows="15" placeholder="내용" aria-label="내용">` +
        xss_filter(conent) +
        `</textarea>
                            <br>
