    ...
    document.getElementById('main_data').innerHTML = `
        <header class="bg-dark py-5">
            <div class="container px-5">
                <div class="row gx-5 align-items-center justify-content-center">
                    ...
                    <div class="col-xl-5 col-xxl-6 d-none d-xl-block text-center"><img class="img-fluid rounded-3 my-5" src="/view/img/lang_file.jpg" alt="..."></div>
                </div>
            </div>
        </header>
        <br>
        ...
        <div class="container" id="featured-3">
            <div class="container px-4" id="featured-3">
                <h2 class="pb-2 border-bottom">진행 중인 분반</h2>
                <div class="row g-4 py-5 row-cols-1 row-cols-lg-3">
                    <div class="feature col">
                        <div class="feature-icon d-inline-flex align-items-center justify-content-center text-bg-primary bg-gradient fs-2 mb-3">
                            <svg xmlns="http://www.w3.org/2000/svg" width="48px" height="48px" style="margin: 10px;" fill="currentColor" class="bi bi-globe2" viewBox="0 0 16 16">
                    ...
                    <div class="feature col">
                        <div class="feature-icon d-inline-flex align-items-center justify-content-center text-bg-primary bg-gradient fs-2 mb-3">
                            <svg xmlns="http://www.w3.org/2000/svg" width="48px" height="48px" style="margin: 10px;" fill="currentColor" class="bi bi-filetype-py" viewBox="0 0 16 16">
                    ...
                    <div class="feature col">
                        <div class="feature-icon d-inline-flex align-items-center justify-content-center text-bg-primary bg-gradient fs-2 mb-3">
                            <svg xmlns="http://www.w3.org/2000/svg" width="48px" height="48px" style="margin: 10px;" fill="currentColor" class="bi bi-braces-asterisk" viewBox="0 0 16 16">
