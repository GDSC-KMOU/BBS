...
if(document.location.pathname === '/ex/study_add') {
                ...
                <div class="row gap-5">
                    <div class="col-md-9 shadow-sm rounded-5" style="margin: auto;">
                        <div class="container px-1">
                            ...
                            <div class="mb-3">
                                <input id="project_add_file_name" type="text" class="form-control" placeholder="팀 이름" aria-label="팀 이름" aria-describedby="basic-addon2">
                            </div>
