...
if (document.location.pathname === "/signup") {
    fetch("/api/set/load/hcaptcha_public")
        ...
        `;
            ...
            document
                .getElementById("signup_save")
                .addEventListener("click", function () {
                    let user_name =
                        document.getElementById("signup_user_name").value;
                    let user_real_name = document.getElementById(
                        "signup_user_real_name"
                    ).value;
                    let password =
