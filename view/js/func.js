    ...
    return `
        <div class="col-xxl-2 shadow rounded-5 board__nav">
            ...
            <li class="board_item text-center" data-filter="A"><a href="/board/main"
                class="text-decoration-none">공지</a> </li>
            <li class="board_item text-center" data-filter="B"><a href="/board/talk" class="text-decoration-none">기술</a>
            </li>
            <li class="board_item text-center" data-filter="C"><a href="/board/free" class="text-decoration-none">자유</a>
            </li>
            <li class="board_item text-center" data-filter="D"><a href="/board/all"
                class="text-decoration-none">전체</a> </li>
            </div>
        </div>
    `;
}
...
document.addEventListener("scroll", () => {
    window.scrollY > 300
        ? $upBtn.classList.add("show_btn")
        : $upBtn.classList.remove("show_btn");
});
